% This is the code for estimating the reference via pFBA and other genotype flux distributions.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % STEP 1 % % % % % 
% % % % % Col0 flux distribution via pFBA % % % % % 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
v=sol.x;
bio_opt=sol.f; % biomass under optimial growth condition
...
csvwrite('nonzeroid_pFBA.csv',idnzero);
%csvwrite('zeroid_pFBA.csv',idzero);

% Output: Col0 flux distribution
save('fluxcol0_pFBA.mat','fluxc')
csvwrite('fluxcol0_pFBA.csv',fluxc);
...
fluxc = load('fluxcol0_pFBA.mat','fluxc');
fluxc = fluxc.fluxc;
...
idnzero = csvread('nonzeroid_pFBA.csv',0,0);
...
csvwrite('fluxgenotype_pFBA.csv',fluxall);
save('fluxgenotype_pFBA.mat','fluxall');
